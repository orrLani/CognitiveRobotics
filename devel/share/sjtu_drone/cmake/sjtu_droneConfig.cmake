...
if("TRUE" STREQUAL "TRUE")
  set(sjtu_drone_SOURCE_PREFIX /home/orr/CognitiveRobotics/src/sjtu-drone)
  set(sjtu_drone_DEVEL_PREFIX /home/orr/CognitiveRobotics/devel)
  ...
  set(sjtu_drone_INSTALL_PREFIX /home/orr/CognitiveRobotics/install)
...
if(NOT "/home/orr/CognitiveRobotics/src/sjtu-drone/include " STREQUAL " ")
  set(sjtu_drone_INCLUDE_DIRS "")
  set(_include_dirs "/home/orr/CognitiveRobotics/src/sjtu-drone/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'Georg Novotny <georg.novotny@technikum-wien.at>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'sjtu_drone' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/orr/CognitiveRobotics/src/sjtu-drone/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/orr/CognitiveRobotics/devel/lib;/home/orr/CognitiveRobotics/devel/lib;/opt/ros/noetic/lib)
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(sjtu_drone_EXPORTED_TARGETS ${${sjtu_drone_dep}_EXPORTED_TARGETS})
endforeach()
